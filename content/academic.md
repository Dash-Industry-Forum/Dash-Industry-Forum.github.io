...
The DASH-IF established the [Grand Challenge on Dynamic Adaptive Streaming over HTTP](https://dashif.org/icme2017grandchallenge/) for the first time at [IEEE ICME 2017](http://www.icme2017.org/). The press release can be found [here](https://multimediacommunication.blogspot.co.at/2017/07/dash-if-awarded-grand-challenge-on.html) and the DASH-IF is pleased to announce the following winners:
