...
### Presentation 1
- Title: A advertising  Working Group: Ad monitoring End to End 
...
### Presentation 1
- Title: Haptics Media in DASH 
- Presenter: Yeshwant Muthusamy, Chris Ullrich 

### Presentation 2
- Title: 5G Media Streaming Status Update
- Presenter: Thomas Stockhammer

## July 17, 2020:
- Title: Video HRD conformance and DASH
- Presenter: Yuriy Reznik

## July 31, 2020

### Presentation 1
- An overview of the High Efficiency Streaming Protocol
...
### Presentation 2  
- Title: W3C DataCue API Introduction
...
## August 14, 2020
- Title: MPEG Network-Based Media Processing and 5G Media Edge Processing
...
## September 11, 2020
- Title: A primer to VVC with focus on High-Level Syntax
...
## October 9, 2020
- Ingest Task Force with special session
Presentation Ali
Slides
...
(slides)
Player discussion
Add a clause to LL-CR on this matter
(Thomas, Ali, Rufael, Theo) coordinate this.


## November 20, 2020
Vudu folks implemented an open source Part 8 POC and wanted to give a talk/demo
Need also intro to the topic
Ali, Iraj, Alex just coordinate to create a nice 1 hour session on November 20.
Please provide an abstract and also let know if other people than DASH-IF should be invited
Special Session: Low-Latency and CDNs - around the blog - December 18, 8am (Thomas checks)
Ali on CMCD results in next year

# Special Sessions 2021

## January ???
- Title: Modern content replacement workflows based on SCTE Specifications
...
### Presentation 1
- Title: Brief Overview on CTA-5004: Common Media Client Data (CMCD)
- Presenter: Will Law (Akamai)
- Abstract: This presentation provides a brief overview on CTA-5004: Common Media Client Data (CMCD)

## Presentation 2
- Title: Use of CMCD in HTTP Adaptive Streaming: Initial Findings
...
## Presentation 3
- Title: LC-EVC: Principles and Application to Adaptive Streaming and the Web (part 1 V-Nova) (part 2 Streaming Media)
...
## May 28, 2021 
- Title: WebRTC-based Premium Streaming Ecosystem
