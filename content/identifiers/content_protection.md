...
`6dd8b3c3-45f4-4a68-bf3a-64168d01a4a6` | Content Protection Solution from ABV DRM (MoDRM), ABV International Pte Ltd. Documentation is available under NDA. For more info: http://www.abvtc.com/. | ABV Content Protection for MPEG DASH (MoDRM v4.7 and above).
`3d5e6d35-9b9a-41e8-b843-dd3c6e72c42c` | ChinaDRM Content Protection system Identifier. ChinaDRM is defined by China Radio and Television Film Industry Standard GY/T 277-2014
For more information, please refer to http://www.chinadrmlab.org | The UUID of @schemeiduri is version 4 UUID per RFC 4122. @value indicates ChinaDRM specific solution provided by various vendor. The ChinaDRM specification can be downloaded from http://www.chinadrmlab.org/index.php?m=content&c=index&a=lists&catid=14
`793b7956-9f94-4946-a942-23e7ef7e44b4` | GOSPELL Digital Technology Co., Ltd. Block F10-13, F518 Idea Land, Bao Yuan Road, Bao’an, 518102, ShenZhen, China, www.gospell.com | VisionCrypt DRM system by GOSPELL. For further information, contact gosdrm@gospell.com